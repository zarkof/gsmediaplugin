...
require 'plugins/gsMediaPlugin/lib/model/om/BasegsMediaFolder.php';
 ...
 */
abstract class BasegsMediaFolderNestedSet extends BasegsMediaFolder implements NodeObject {
	...
	public function save(PropelPDO $con = null)
	{
		...
		if (empty($left) || empty($right)) {
			$root = gsMediaFolderPeer::retrieveRoot($this->getScopeIdValue(), $con);
			gsMediaFolderPeer::insertAsLastChildOf($this, $root, $con);
		}
	...
	public function delete(PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::deleteDescendants($this, $con);
	}
	...
	{
		gsMediaFolderPeer::createRoot($this);
		return $this;
	}
	...
	{
		if (null === $this->level) {
			$this->level = gsMediaFolderPeer::getLevel($this, $con);
		}
		return $this->level;
	}
	...
	{
		return gsMediaFolderPeer::getPath($this, $con);
	}
	...
	{
		return gsMediaFolderPeer::getNumberOfChildren($this, $con);
	}
	...
	{
		return gsMediaFolderPeer::getNumberOfDescendants($this, $con);
	}
	...
	public function getChildren(PropelPDO $con = null)
	{
		...
		return gsMediaFolderPeer::retrieveChildren($this, $con);
	}
	...
	public function getDescendants(PropelPDO $con = null)
	{
		...
		return gsMediaFolderPeer::retrieveDescendants($this, $con);
	}
	 ...
	 *
	 * @param      array of gsMediaFolder $children	array of Propel node object
	 * @return     gsMediaFolder The current object (for fluent API support)
	 */
	 ...
	 *
	 * @param      gsMediaFolder $parent Propel node object
	 * @return     gsMediaFolder The current object (for fluent API support)
	 */
	public function setParentNode(NodeObject $parent = null)
	{
		$this->parentNode = (true === ($this->hasParentNode = gsMediaFolderPeer::isValid($parent))) ? $parent : null;
		return $this;
	}
	 ...
	 *
	 * @param      gsMediaFolder $node Propel node object
	 * @return     gsMediaFolder The current object (for fluent API support)
	 */
	public function setPrevSibling(NodeObject $node = null)
	{
		$this->prevSibling = $node;
		$this->hasPrevSibling = gsMediaFolderPeer::isValid($node);
		return $this;
	}
	...
	public function setNextSibling(NodeObject $node = null)
	{
		...
		$this->hasNextSibling = gsMediaFolderPeer::isValid($node);
		return $this;
	}
	...
	{
		return gsMediaFolderPeer::isRoot($this);
	}
	...
	{
		return gsMediaFolderPeer::isLeaf($this);
	}
	...
	{
		return gsMediaFolderPeer::isEqualTo($this, $node);
	}
	...
	public function hasParent(PropelPDO $con = null)
	{
		if (null === $this->hasParentNode) {
			gsMediaFolderPeer::hasParent($this, $con);
		}
	...
	{
		return  gsMediaFolderPeer::hasChildren($this);
	}
	...
	public function hasPrevSibling(PropelPDO $con = null)
	{
		if (null === $this->hasPrevSibling) {
			gsMediaFolderPeer::hasPrevSibling($this, $con);
		}
	...
	public function hasNextSibling(PropelPDO $con = null)
	{
		if (null === $this->hasNextSibling) {
			gsMediaFolderPeer::hasNextSibling($this, $con);
		}
	...
	{
		if (null === $this->hasParentNode) {
			$this->parentNode = gsMediaFolderPeer::retrieveParent($this, $con);
			$this->hasParentNode = gsMediaFolderPeer::isValid($this->parentNode);
		}
	...
	public function retrieveFirstChild(PropelPDO $con = null)
	{
		if ($this->hasChildren($con)) {
			...
			return gsMediaFolderPeer::retrieveFirstChild($this, $con);
		}
		return false;
	}
	...
	public function retrieveLastChild(PropelPDO $con = null)
	{
		if ($this->hasChildren($con)) {
			...
			return gsMediaFolderPeer::retrieveLastChild($this, $con);
		}
		return false;
	}
	 ...
	 *
	 * @param      gsMediaFolder $parent	Propel object for destination node
	 * @param      PropelPDO $con Connection to use.
	 * @return     gsMediaFolder The current object (for fluent API support)
	...
	public function insertAsFirstChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		if (!$this->isNew())
		{
			throw new PropelException("gsMediaFolder must be new.");
		}
		gsMediaFolderPeer::insertAsFirstChildOf($this, $parent, $con);
		return $this;
	}
	...
	public function insertAsLastChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::insertAsLastChildOf($this, $parent, $con);
		return $this;
	}
	...
	public function insertAsPrevSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::insertAsPrevSiblingOf($this, $dest, $con);
		return $this;
	}
	...
	public function insertAsNextSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::insertAsNextSiblingOf($this, $dest, $con);
		return $this;
	}
	...
	public function moveToFirstChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		if ($this->isNew())
		{
			throw new PropelException("gsMediaFolder must exist in tree.");
		}
		gsMediaFolderPeer::moveToFirstChildOf($parent, $this, $con);
		return $this;
	}
	...
	public function moveToLastChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::moveToLastChildOf($parent, $this, $con);
		return $this;
	}
	...
	public function moveToPrevSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::moveToPrevSiblingOf($dest, $this, $con);
		return $this;
	}
	...
	public function moveToNextSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::moveToNextSiblingOf($dest, $this, $con);
		return $this;
	}
	...
	{
		gsMediaFolderPeer::insertAsParentOf($this, $node, $con);
		return $this;
	}
