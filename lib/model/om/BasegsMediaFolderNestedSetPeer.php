...
require 'plugins/gsMediaPlugin/lib/model/om/BasegsMediaFolderPeer.php';

/**
 * Base static class for performing query operations on the tree contained by the 'gs_media_folder' table.
 *
 * 
 *
 * This class was autogenerated by Propel 1.3.0-dev on:
 *
 * Wed Feb 11 16:47:45 2009
 *
 * @package    plugins.gsMediaPlugin.lib.model.om
 */
abstract class BasegsMediaFolderNestedSetPeer extends BasegsMediaFolderPeer implements NodePeer {

	/**
	 * Left column for the set
	 */
	const LEFT_COL = 'gs_media_folder.TREE_LEFT';

	/**
	 * Right column for the set
	 */
	const RIGHT_COL = 'gs_media_folder.TREE_RIGHT';
	 ...
	 *
	 * @param      gsMediaFolder $node	Propel object for model
	 ...
	 * @return     gsMediaFolder			Propel object for root node
	 */
	public static function retrieveRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		return gsMediaFolderPeer::doSelectOne($c, $con);
	}

	/**
	 * Inserts $child as first child of given $parent node
	 *
	 * @param      gsMediaFolder $child	Propel object for child node
	 * @param      gsMediaFolder $parent	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      gsMediaFolder $node		Propel object for destination node
	 * @param      gsMediaFolder $sibling	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      gsMediaFolder $parent	Propel object for given parent node
	 * @param      gsMediaFolder $node	Propel object for given destination node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      gsMediaFolder $node	Propel object as root node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	public static function insertRoot(NodeObject $node, PropelPDO $con = null)
	{
		...
		gsMediaFolderPeer::insertAsParentOf(gsMediaFolderPeer::retrieveRoot($sidv, $con), $node, $con);
	}
	 ...
	 * @param      gsMediaFolder $child	Propel object to become child node
	 * @param      gsMediaFolder $parent	Propel object as parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	...
	public static function deleteRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		$root = gsMediaFolderPeer::retrieveRoot($scopeId, $con);
		if (gsMediaFolderPeer::getNumberOfChildren($root) == 1) {
			return gsMediaFolderPeer::deleteNode($root, $con);
		} else {
			return false;
		}
	}
	 ...
	 * Delete $dest node
	 *
	 * @param      gsMediaFolder $dest	Propel object node to delete
	 * @param      PropelPDO $con	Connection to use.
	 * @return     boolean		Deletion status
	 */
	public static function deleteNode(NodeObject $dest, PropelPDO $con = null)
	{
		if ($dest->getLeftValue() == 1) {
			...
			return gsMediaFolderPeer::deleteRoot($con);
		}
	 ...
	 *
	 * @param      gsMediaFolder $dest	Propel object for destination node
	 * @param      gsMediaFolder $node	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      gsMediaFolder $node	Propel object for src node
	 * @param      PropelPDO $con	Connection to use.
	...
	public static function retrievePrevSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$prevSibling = gsMediaFolderPeer::doSelectOne($c, $con);
	...
	public static function retrieveNextSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$nextSibling = gsMediaFolderPeer::doSelectOne($c, $con);
	...
	public static function retrieveTree($scopeId = null, PropelPDO $con = null)
	{
		...
		$stmt = gsMediaFolderPeer::doSelectStmt($c, $con);
		if (false !== ($row = $stmt->fetch(PDO::FETCH_NUM))) {
			$omClass = gsMediaFolderPeer::getOMClass($row, 0);
			$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);

			$root = new $cls();
			$root->hydrate($row);
			$root->setLevel(0);
			gsMediaFolderPeer::hydrateDescendants($root, $stmt);
			gsMediaFolderPeer::addInstanceToPool($root);
	 ...
	 *
	 * @param      gsMediaFolder $node	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 */
	public static function retrieveBranch(NodeObject $node, PropelPDO $con = null)
	{
		return gsMediaFolderPeer::retrieveDescendants($node, $con);
	}
	...
	public static function retrieveChildren(NodeObject $node, PropelPDO $con = null)
	{
		...
		return gsMediaFolderPeer::hydrateChildren($node, $stmt);
	}
	...
	public static function retrieveDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		return gsMediaFolderPeer::hydrateDescendants($node, $stmt);
	}
	...
	{
		$parent = gsMediaFolderPeer::retrieveParent($node, $con);
		$siblings = gsMediaFolderPeer::retrieveChildren($parent, $con);
	...
	public static function retrieveParent(NodeObject $node, PropelPDO $con = null)
	{
		...
		$parent = gsMediaFolderPeer::doSelectOne($c, $con);
	...
	{
		$children = gsMediaFolderPeer::retrieveChildren($node);
	 ...
	 *
	 * @param      gsMediaFolder $node	Propel object of node to create path to
	 * @param      PropelPDO $con	Connection to use.
	 ...
	 *
	 * @param      gsMediaFolder $child	Propel object for node
	 * @param      gsMediaFolder $parent	Propel object for node
	 * @return     bool
	 */
	 ...
	 * @param      gsMediaFolder $node1		Propel object for node
	 * @param      gsMediaFolder $node2		Propel object for node
	 * @return     bool
	 */
	 ...
	 *
	 * @param      gsMediaFolder $node		Propel object for node
	 * @param      PropelPDO $con		Connection to use.
	 * @return     bool
	 */
	public static function hasParent(NodeObject $node, PropelPDO $con = null)
	{
		return gsMediaFolderPeer::isValid(gsMediaFolderPeer::retrieveParent($node, $con));
	}
	...
	{
		return gsMediaFolderPeer::isValid(gsMediaFolderPeer::retrievePrevSibling($node, $con));
	}
	...
	{
		return gsMediaFolderPeer::isValid(gsMediaFolderPeer::retrieveNextSibling($node, $con));
	}
	...
	public static function deleteDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		$result = gsMediaFolderPeer::doDelete($c, $con);
	 ...
	 *
	 * @param      int/gsMediaFolder $node	Primary key/instance of required node
	 * @param      PropelPDO $con		Connection to use.
	...
	public static function getNode($node, PropelPDO $con = null)
	{
		if (is_object($node)) {
			...
			$object = gsMediaFolderPeer::retrieveByPK($node, $con);
	...
	protected static function hydrateDescendants(NodeObject $node, PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null === ($child = gsMediaFolderPeer::getInstanceFromPool($key))) {
				$child = new $cls();
				$child->hydrate($row);
			}
			...
			if ($child->hasChildren()) {
				$descendants = array_merge($descendants, gsMediaFolderPeer::hydrateDescendants($child, $stmt));
			} else {
			...
			gsMediaFolderPeer::addInstanceToPool($child);
	...
	protected static function updateLoadedNode(NodeObject $node, $delta, PropelPDO $con = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			...
			if (!empty($keys)) {
				...
				$criteria->add(gsMediaFolderPeer::ID, $keys, Criteria::IN);

				$stmt = gsMediaFolderPeer::doSelectStmt($criteria, $con);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
					$key = gsMediaFolderPeer::getPrimaryKeyHashFromRow($row, 0);
					if (null !== ($object = gsMediaFolderPeer::getInstanceFromPool($key))) {
	 ...
	 *
	 * @param      gsMediaFolder $node Propel object for node to update
	...
	protected static function shiftRLValues($first, $delta, PropelPDO $con = null, $scopeId = null)
	{
		...
		$whereCriteria = new Criteria(gsMediaFolderPeer::DATABASE_NAME);
		...
		$valuesCriteria = new Criteria(gsMediaFolderPeer::DATABASE_NAME);
		$valuesCriteria->add(
			self::LEFT_COL,
...
} // BasegsMediaFolderNestedSetPeer
