...
abstract class BasegsMediaFormat extends BaseObject  implements Persistent {
  ...
  const PEER = 'gsMediaFormatPeer';
	 ...
	 */
	protected $collgsMediaFileFormats;

	/**
	 * @var        Criteria The criteria used to select the current contents of collgsMediaFileFormats.
	 */
	private $lastgsMediaFileFormatCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collgsMediaFileFormats !== null) {
				foreach ($this->collgsMediaFileFormats as $referrerFK) {
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getgsMediaFileFormats() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addgsMediaFileFormat($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collgsMediaFileFormats collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addgsMediaFileFormats()
	 */
	public function cleargsMediaFileFormats()
	{
		$this->collgsMediaFileFormats = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collgsMediaFileFormats collection (array).
	 *
	 * By default this just sets the collgsMediaFileFormats collection to an empty array (like clearcollgsMediaFileFormats());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initgsMediaFileFormats()
	{
	 ...
	 * @return     array gsMediaFileFormat[]
	 * @throws     PropelException
	 */
	public function getgsMediaFileFormats($criteria = null, PropelPDO $con = null)
	{
		...
		return $this->collgsMediaFileFormats;
	}

	/**
	 * Returns the number of related gsMediaFileFormat objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related gsMediaFileFormat objects.
	 * @throws     PropelException
	 */
		...
		if ($this->collgsMediaFileFormats === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastgsMediaFileFormatCriteria) || !$this->lastgsMediaFileFormatCriteria->equals($criteria)) {
					...
					$count = count($this->collgsMediaFileFormats);
				}
			} else {
				$count = count($this->collgsMediaFileFormats);
			}
	...
	/**
	 * Method called to associate a gsMediaFileFormat object to this object
	 * through the gsMediaFileFormat foreign key attribute.
	 *
	 * @param      gsMediaFileFormat $l gsMediaFileFormat
	 * @return     void
	 * @throws     PropelException
	 */
	public function addgsMediaFileFormat(gsMediaFileFormat $l)
	{
		if ($this->collgsMediaFileFormats === null) {
			$this->initgsMediaFileFormats();
		}
	...
	{
		if ($deep) {
			if ($this->collgsMediaFileFormats) {
				foreach ((array) $this->collgsMediaFileFormats as $o) {
